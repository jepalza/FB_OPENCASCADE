...
#include <BRepPrimAPI_MakeSphere.hxx> // jepalza, esferas
...
// Joseba Epalza, añadido la creacion de esferas
BRepPrimAPIMakeBox BRepPrimAPIMakeSphere_Init(gpAx2 position, double rad) {
    gp_Ax2 *p = (gp_Ax2 *)position;
    BRepPrimAPI_MakeSphere *ret = new BRepPrimAPI_MakeSphere(*p, rad);
    return (void*) ret;
}

TopoDSShape BRepPrimAPIMakeSphere_Shape(BRepPrimAPIMakeSphere makeSphere) {
    BRepPrimAPI_MakeSphere *Sphere = (BRepPrimAPI_MakeSphere *)makeSphere;
...
void BRepPrimAPIMakeSphere_Free(BRepPrimAPIMakeSphere makeSphere) {
    BRepPrimAPI_MakeSphere *Sphere = (BRepPrimAPI_MakeSphere *)makeSphere;
    delete Sphere;
}